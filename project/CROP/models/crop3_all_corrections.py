...
class Crop3AllCorrections(CropBaseModel):
    ...
    def second_filter(self, filter_1 ,mixed_input, alpha, bias, slope,delta,theta):
        #print("second filter")
        x_mix_filter_1 =  2 * mixed_input - filter_1
        ...
        mask_source1 = mask_source1 - theta*((self.source1_estimation+self.source2_estimation)/2-mixed_input)
    ...
    def decode(self):
        ...
        if iteration<threshold:
            ...
            reconstructed_source1, mask_source1, predictions_1 = (
                self.second_filter(self.source2_estimation ,self.mixed_input, alpha_2, bias, slope,delta,theta)
            )
            ...
            reconstructed_source2, mask_source2, predictions_2 = (
                self.second_filter(reconstructed_source1,  self.mixed_input, alpha_1, bias, slope,delta,theta)
            )
