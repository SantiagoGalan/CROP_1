...
class Crop3Mod(CropBaseModel):
    ...
    def filter(self, filter_1 ,mixed_input, alpha, bias, slope):
        ...
        mask_x__x_e = (x__x_e - bias) * slope
     
        mask_x__x_e = tf.sigmoid(mask_x__x_e)

        x_mix_filter_1 = x_mix_filter_1-x__x_e + (cvae_output)*mask_x__x_e
...
class Crop3mod(CropBaseModel):
    ...
    def filter(self, filter_1 ,mixed_input, alpha, bias, slope):
        ...
        x_mix_filter_1 = tf.clip_by_value(x_mix_filter_1, 0, 1) 
        x__x = (self.source1_estimation + self.source2_estimation) / 2
        x_mix_filter_1 = x_mix_filter_1 -(x_mix_filter_1-cvae_output)*x__x
